...
public class ConverterApp {
	...
	public static void main(String args[]) {
		...
		File input = fileui.getInputFile();
		FileReader filereader = new FileReader(input);
		File output = fileui.getOutputFile();
		FileWriter filewriter = new FileWriter(output);
		
		TABtoXML tabtoxml = new TABtoXML();

		Converter converter = new Converter(filereader, filewriter, tabtoxml);
